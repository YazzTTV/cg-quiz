  ...
  return (
    ...
    >
      ...
      <main className="relative z-10 mx-auto max-w-md px-4 py-28">
        ...
        >
          <h1 className="mb-2 text-center text-4xl font-bold">Inscription</h1>
          <p className="mb-8 text-center text-lg" style={{ color: 'rgba(248, 249, 250, 0.78)' }}>
            Créez votre compte pour démarrer votre progression sur le Score IAE.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              <label htmlFor="name" className="mb-2 block text-sm font-semibold" style={{ color: 'rgba(248, 249, 250, 0.85)' }}>
                Nom (optionnel)
              </label>
              <input
                id="name"
          ...
          <p className="mt-5 text-center text-sm" style={{ color: 'rgba(248, 249, 250, 0.75)' }}>
            Déjà un compte ?{' '}
            <Link href="/login" style={{ color: '#f4e4c1', textDecoration: 'underline' }}>
              Se connecter
            </Link>
          </p>
        </section>
